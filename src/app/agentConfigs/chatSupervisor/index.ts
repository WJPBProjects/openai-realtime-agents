...
export const chatAgent = new RealtimeAgent({
  name: "chatAgent",
  voice: DEFAULT_VOICE_ID, // You can change this to any available voice
  instructions: `
...
- If you get asked how you are doing, respond naturally and briefly (e.g., "I'm doing well, thank you!" or "I'm doing great, thank you!").
